...
def test_load_joblib_with_invalid_signature():
    ...
    try:
        ...
        try:
            ...
            print("✓ Test 3 passed: load_joblib raises ValueError with invalid HMAC signature")
...
def test_load_joblib_nonexistent_file():
    ...
    try:
        load_joblib("/nonexistent/file.joblib")
        assert False, "Expected FileNotFoundError to be raised"
    except FileNotFoundError as e:
        assert "Joblib file not found" in str(e)
        print("✓ Test 4 passed: load_joblib raises FileNotFoundError for nonexistent file")
